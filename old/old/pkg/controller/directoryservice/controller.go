...
func (bc *DirectoryServiceController) Reconcile(k types.ReconcileKey) error {
	...
	// todo: what is the difference between this ane the informer below
	//_, err := bc.KubernetesClientSet().AppsV1().StatefulSets(ds.Namespace).Get(ds.Name,nil)
	//_, err := bc.KubernetesClientSet
