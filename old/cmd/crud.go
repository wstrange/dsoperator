...
import (
	...
	// do we need this? Keep dep happy
	...
	ds "github.com/ForgeRock/dsoperator/pkg/operator"
...
func main() {
	...
	ssClient := clientset.AppsV1().StatefulSets(apiv1.NamespaceDefault)

	fmt.Println("Creating statefulset...")
	sresult, err := ssClient.Create(dsx)
	if err != nil {
		panic(err)
	}
