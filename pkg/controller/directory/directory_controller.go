...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileDirectory{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	// Create a new controller
	c, err := controller.New("directory-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}
...
var _ reconcile.Reconciler = &ReconcileDirectory{}

// ReconcileDirectory reconciles a Directory object
type ReconcileDirectory struct {
	client.Client
	scheme *runtime.Scheme
}

// Reconcile reads that state of the cluster for a Directory object and makes changes based on the state read
// and what is in the Directory.Spec
